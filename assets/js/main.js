...
-------------------------------------------------- */
	...
	function initParallax () {
		...
		if (!isSafari) {
			...
			$(".number-counters").parallax("50%", -0.7);
		...
		if (hasCounters) {
			...
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-1', 0, 1.3, 1, 3, options);
					counter1.start();
					// Counter 2
					var counter2 = new CountUp('count-2', 0, 1.2, 1, 3, options);
					counter2.start();
					// Counter 3
					var counter3 = new CountUp('count-3', 0, 6.5, 1, 3, options);
					counter3.start();
					// Counter 4
					var counter4 = new CountUp('count-4', 0, 1.3, 1, 3, options);
					counter4.start();
					// init only once
					this.destroy();
				},
